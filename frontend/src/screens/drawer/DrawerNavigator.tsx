...
import FriendsListScreen from '../friends/components/FriendsList';
...
const DrawerNavigator = () => (
  <Drawer.Navigator>
    ...
    <Drawer.Screen name="ProfilePreview" component={ProfilePreviewScreen} options={{headerShown: false}}/>
